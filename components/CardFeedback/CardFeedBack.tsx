...
interface ImageActionBannerProps {
  ...
  gradient?: string; // new prop to accept a custom gradient color
}
...
export function CardFeedBack({
  ...
  return (
    ...
    >
      <Overlay
        gradient={`linear-gradient(145deg, ${theme.colors.yellow[5]} 20%, ${theme.colors.yellow[7]} 50%, ${theme.colors.blue[5]} 100%)`}
        opacity={0.55}
        zIndex={0}
      />
